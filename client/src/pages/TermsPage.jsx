    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 flex-1 space-y-6">
        ...
        <div className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-4 text-slate-600 dark:text-slate-300">
          <p>Welcome to Biizora. By accessing or using our financial operating system web application, you agree to bound by these terms.</p>
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">1. Subscription & Account Access</h3>
          <p>Biizora provides software services under monthly or annual subscription plans. Free trial accounts automatically convert to chosen plan tiers unless cancelled prior to trial expiration.</p>
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">2. GST Filing Disclaimer</h3>
          <p>Biizora facilitates automated GSTR-1 and GSTR-3B summary calculations based on user inputs. Users remain responsible for submitting final tax returns to the GSTN portal.</p>
