    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 flex-1 space-y-6">
        ...
        <div className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-4 text-slate-600 dark:text-slate-300">
          <p>At Amexora Technologies Private Limited, we prioritize your financial data privacy. This policy outlines how we collect, use, and protect your company information, customer ledgers, and invoice data.</p>
          ...
          <p>Your business transaction records are never shared with external model trainers or third parties. OpenAI models integrated into Amexora process prompt tokens strictly within zero-retention private enterprise sessions.</p>
